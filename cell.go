...
func (c *xlsxC) setCellFloat(value float64, prec, bitSize int) { _ = "STUB: not implemented"; return }

func formatCellFloat(value float64, prec, bitSize int) string { _ = "STUB: not implemented"; return "" }
...
func (c *xlsxC) getCellDefault(raw bool) { _ = "STUB: not implemented"; return }

func isNumWithinPrecision(str string) bool { _ = "STUB: not implemented"; return false }
